...
(function($) {
	...
	skel.init({
		...
		breakpoints: {
			...
			xlarge: { media: '(max-width: 1024px)', href: '{{ site.baseurl }}/css/style-xlarge.css' },
			large: { media: '(max-width: 1024px)', href: '{{ site.baseurl }}/css/style-large.css', containers: '42em', grid: { gutters: ['1.5em', 0] }, viewport: { scalable: false } },
