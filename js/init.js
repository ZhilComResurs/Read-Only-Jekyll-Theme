...
(function($) {
	...
	skel.init({
		...
		breakpoints: {
			...
			xlarge: { media: '(max-width: 1680px)', href: '{{ site.baseurl }}/css/style-medium.css' },
			large: { media: '(max-width: 1280px)', href: '{{ site.baseurl }}/css/style-medium.css', containers: '42em', grid: { gutters: ['1.5em', 0] }, viewport: { scalable: false } },
